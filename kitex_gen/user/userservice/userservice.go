...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"Change":   kitex.NewMethodInfo(changeHandler, newUserServiceChangeArgs, newUserServiceChangeResult, false),
	}
...
func changeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*user.UserServiceChangeArgs)
	realResult := result.(*user.UserServiceChangeResult)
	success, err := handler.(user.UserService).Change(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newUserServiceChangeArgs() interface{} {
	return user.NewUserServiceChangeArgs()
}

func newUserServiceChangeResult() interface{} {
	return user.NewUserServiceChangeResult()
}
...
func (p *kClient) Change(ctx context.Context, req *user.ChangeRequest) (r *user.ChangeResponse, err error) {
	var _args user.UserServiceChangeArgs
	_args.Req = req
	var _result user.UserServiceChangeResult
