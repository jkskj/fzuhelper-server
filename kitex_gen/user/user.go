...
func (p *ChangeRequest) GetUsername() (v string) {
	return p.Username
}

func (p *ChangeRequest) GetPassword() (v string) {
	return p.Password
}

func (p *ChangeRequest) GetNewPassword_() (v string) {
	return p.NewPassword_
}
func (p *ChangeRequest) SetUsername(val string) {
	p.Username = val
}
func (p *ChangeRequest) SetPassword(val string) {
	p.Password = val
}
func (p *ChangeRequest) SetNewPassword_(val string) {
	p.NewPassword_ = val
}
...
func (p *ChangeRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ChangeRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ChangeRequest) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Username = v
...
func (p *ChangeRequest) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Password = v
...
func (p *ChangeRequest) ReadField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.NewPassword_ = v
...
func (p *ChangeRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("ChangeRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *ChangeRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("username", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Username); err != nil {
...
func (p *ChangeRequest) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("password", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Password); err != nil {
...
func (p *ChangeRequest) writeField3(oprot thrift.TProtocol) (err error) {
...
func (p *ChangeRequest) DeepEqual(ano *ChangeRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ChangeRequest) Field1DeepEqual(src string) bool {
...
func (p *ChangeRequest) Field2DeepEqual(src string) bool {
...
func (p *ChangeRequest) Field3DeepEqual(src string) bool {
...
var ChangeResponse_Base_DEFAULT *BaseResp

func (p *ChangeResponse) GetBase() (v *BaseResp) {
	if !p.IsSetBase() {
		return ChangeResponse_Base_DEFAULT
	}
	return p.Base
}
func (p *ChangeResponse) SetBase(val *BaseResp) {
	p.Base = val
}
...
func (p *ChangeResponse) IsSetBase() bool {
	return p.Base != nil
}

func (p *ChangeResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ChangeResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ChangeResponse) ReadField1(iprot thrift.TProtocol) error {
	p.Base = NewBaseResp()
	if err := p.Base.Read(iprot); err != nil {
		return err
	}
...
func (p *ChangeResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("ChangeResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *ChangeResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("base", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Base.Write(oprot); err != nil {
...
func (p *ChangeResponse) DeepEqual(ano *ChangeResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ChangeResponse) Field1DeepEqual(src *BaseResp) bool {
...
func (p *UserServiceClient) Change(ctx context.Context, req *ChangeRequest) (r *ChangeResponse, err error) {
	var _args UserServiceChangeArgs
	_args.Req = req
	var _result UserServiceChangeResult
	if err = p.Client_().Call(ctx, "Change", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewUserServiceProcessor(handler UserService) *UserServiceProcessor {
	...
	self.AddToProcessorMap("Change", &userServiceProcessorChange{handler: handler})
	return self
}
...
type userServiceProcessorChange struct {
	handler UserService
}

func (p *userServiceProcessorChange) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := UserServiceChangeArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("Change", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := UserServiceChangeResult{}
	var retval *ChangeResponse
	if retval, err2 = p.handler.Change(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing Change: "+err2.Error())
		oprot.WriteMessageBegin("Change", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("Change", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type UserServiceChangeArgs struct {
	Req *ChangeRequest `thrift:"req,1" frugal:"1,default,ChangeRequest" json:"req"`
}

func NewUserServiceChangeArgs() *UserServiceChangeArgs {
	return &UserServiceChangeArgs{}
}

func (p *UserServiceChangeArgs) InitDefault() {
	*p = UserServiceChangeArgs{}
}

var UserServiceChangeArgs_Req_DEFAULT *ChangeRequest

func (p *UserServiceChangeArgs) GetReq() (v *ChangeRequest) {
	if !p.IsSetReq() {
		return UserServiceChangeArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *UserServiceChangeArgs) SetReq(val *ChangeRequest) {
	p.Req = val
}

var fieldIDToName_UserServiceChangeArgs = map[int16]string{
	1: "req",
}

func (p *UserServiceChangeArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *UserServiceChangeArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceChangeArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceChangeArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewChangeRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *UserServiceChangeArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("Change_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *UserServiceChangeArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *UserServiceChangeArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceChangeArgs(%+v)", *p)
}

func (p *UserServiceChangeArgs) DeepEqual(ano *UserServiceChangeArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *UserServiceChangeArgs) Field1DeepEqual(src *ChangeRequest) bool {
...
type UserServiceChangeResult struct {
	Success *ChangeResponse `thrift:"success,0,optional" frugal:"0,optional,ChangeResponse" json:"success,omitempty"`
}

func NewUserServiceChangeResult() *UserServiceChangeResult {
	return &UserServiceChangeResult{}
}

func (p *UserServiceChangeResult) InitDefault() {
	*p = UserServiceChangeResult{}
}

var UserServiceChangeResult_Success_DEFAULT *ChangeResponse

func (p *UserServiceChangeResult) GetSuccess() (v *ChangeResponse) {
	if !p.IsSetSuccess() {
		return UserServiceChangeResult_Success_DEFAULT
	}
	return p.Success
}
func (p *UserServiceChangeResult) SetSuccess(x interface{}) {
	p.Success = x.(*ChangeResponse)
}

var fieldIDToName_UserServiceChangeResult = map[int16]string{
	0: "success",
}

func (p *UserServiceChangeResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UserServiceChangeResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceChangeResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceChangeResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewChangeResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *UserServiceChangeResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("Change_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *UserServiceChangeResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *UserServiceChangeResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceChangeResult(%+v)", *p)
}

func (p *UserServiceChangeResult) DeepEqual(ano *UserServiceChangeResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *UserServiceChangeResult) Field0DeepEqual(src *ChangeResponse) bool {
